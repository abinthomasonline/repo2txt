/**
 * Azure DevOps authentication component
...
export function AzureAuth() {
  ...
  const handleTokenChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (newToken) {
      sessionStorage.setItem('azure_token', newToken);
      ...
      {showInfo && (
        <div className="rounded-md bg-blue-50 dark:bg-blue-900/20 p-3 text-sm">
          <p className="text-blue-800 dark:text-blue-200 mb-2">
            Azure DevOps requires authentication for all repository operations.
          </p>
          <p className="text-blue-700 dark:text-blue-300 mb-3">
            Your PAT needs <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">Code (Read)</code> scope.
          </p>

/**
 * Azure DevOps URL input component
...
interface AzureUrlInputProps {
  onValidUrl?: (url: string) => void;
  onUrlChange?: (url: string, isValid: boolean) => void;
  hideSubmitButton?: boolean;
}

export function AzureUrlInput({ onValidUrl, onUrlChange, hideSubmitButton = false }: AzureUrlInputProps) {
  ...
  const provider = useMemo(() => new AzureDevOpsProvider(), []);
        ...
        <div className="flex gap-2">
          <div className="flex-1">
            <input
              ...
              placeholder="https://dev.azure.com/myorg/myproject/_git/myrepo"
